		...
		<div class="container">
			<div class="text-center">
				...
				<div class="col-md-3 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
					<div class="text-center">
						<img src="img/minimart.jpg" style="width: 250px; height: 125px; border-bottom-right-radius: 100px; border-top-left-radius: 100px;">
						<h3>MINIMART</h3>
					</div>
				...
				<div class="col-md-3 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
					<div class="text-center">
						<img src="img/minicafe.jpg" style="width: 250px; height: 125px; border-bottom-right-radius: 100px; border-top-left-radius: 100px;">
						<h3>MINICAFE</h3>
					</div>
					<div class="contact-info">
						<ul>
				...
				<div class="col-md-3 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms">
					<div class="text-center">
						<img src="img/bookstore.jpg" style="width: 250px; height: 125px; border-bottom-right-radius: 100px; border-top-left-radius: 100px;">
						<h3>BOOKSTORE</h3>
					</div>
					<div class="contact-info">
						<ul>
